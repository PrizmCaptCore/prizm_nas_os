...
PRIZM NAS OS에 기여해 주신 모든 분들께 감사드립니다! 🎉

## 프로젝트 리더

- **PrizmCaptCore** - 프로젝트 창립자 및 주요 개발자
...
프로젝트에 기여하고 이 목록에 이름을 올리고 싶으신가요?
...
### 프로젝트 영감
- Arch Linux 커뮤니티
- TrueNAS, Synology, QNAP 팀들
- r/selfhosted, r/homelab 커뮤니티
...
**여러분의 기여가 PRIZM NAS OS를 더 좋게 만듭니다!**
